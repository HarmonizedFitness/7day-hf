...
const SplashScreen: React.FC = () => {
  ...
  return <div className={`min-h-screen flex flex-col items-center justify-center bg-[#C0AEA0] transition-opacity duration-500 p-4 ${fadeOut ? 'opacity-0' : 'opacity-100'}`}>
