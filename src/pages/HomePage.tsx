  ...
  return <div className="container max-w-4xl mx-auto px-4 py-8 bg-stone-800">
      <header className="flex justify-between items-center mb-6">
        <div className="text-center flex-grow">
          ...
          <h2 className="text-xl md:text-2xl font-medium text-gray-200 mb-4">The First Step</h2>
      ...
      <section className="bg-stone-700 rounded-lg shadow-md p-6 mb-8">
        <h3 className="text-xl font-semibold mb-4 text-white text-center">This Week is About Establishing Foundations</h3>
        <p className="mb-6 leading-relaxed text-gray-200 text-center">
      ...
      <section className="bg-stone-700 rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 border rounded-md border-gray-400 bg-stone-600">
            <h4 className="text-lg font-medium text-burnt-orange mb-2 text-amber-200">Daily Structure</h4>
          ...
          <div className="p-4 border rounded-md border-gray-400 bg-stone-600">
            <h4 className="text-lg font-medium text-burnt-orange mb-2 text-yellow-200">Training Focus</h4>
            <ul className="list-disc pl-5 space-y-1 text-gray-200">
      ...
      <section className="text-center">
        <p className="italic mb-4 text-gray-200">Ready to take the first step!?</p>
